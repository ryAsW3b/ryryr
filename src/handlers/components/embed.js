...
module.exports = (client) => {
    ...
    client.errMissingPerms = async function ({
        ...
        embed.setTitle(`${client.emotes.normal.error}・Erreur`)
        embed.setDescription(`Vous n'avez pas les permissions nécessaires`)
        embed.addFields(
    ...
    client.errNoPerms = async function ({
        ...
        embed.setTitle(`${client.emotes.normal.error}・Erreur`)
        embed.setDescription(`Je n'ai pas les permissions nécessaires`)
        embed.addFields(
            { name: "Permissions requises", value: `\`\`\`${perms}\`\`\``},
        )
        embed.setColor('#050505')
    ...
    client.errWait = async function ({
        ...
        embed.setTitle(`${client.emotes.normal.error}・Erreur`)
        embed.setDescription(`Vous avez déjà fait cela une fois`)
        embed.addFields(
            { name: "Réessayez le", value: `<t:${time}:f>`},
        )
        embed.setColor('#050505')
